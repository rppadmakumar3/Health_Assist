...
training = pd.read_csv("/backend/disease_prediction/data/Training.csv")
testing = pd.read_csv("/backend/disease_prediction/data/Testing.csv")
...
# Save the modified dataframes to CSV files in the output directory
add_noise(train).to_csv(os.path.join(output_directory, "Training.csv"), index=None)
add_noise(test).to_csv(os.path.join(output_directory, "Testing.csv"), index=None)
