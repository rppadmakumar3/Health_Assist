...
# Define the default dataset path
DEFAULT_DATASET_PATH = "/home/ubuntu/HealthAssist/backend/medication_qaqc/data"
...
class MvtecAdDataset(Dataset):
    ...
    def __init__(self, root=DEFAULT_DATASET_PATH):  # Use the default path here
